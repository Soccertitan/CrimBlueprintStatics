...
struct CRIMBLUEPRINTSTATICS_API FSkeletalMeshMergeParams
{
	...
	// Does the resulting mesh needs to be accessed by the CPU for any reason (e.g. for spawning particle effects).
	UPROPERTY(EditAnywhere, BlueprintReadWrite, NotReplicated)
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Crim Blueprint Statics|Mesh Merge", meta = (UnsafeDuringActorConstruction = "true"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Crim Blueprint Statics|Mesh Merge")
